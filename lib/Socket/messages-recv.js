...
const makeMessagesRecvSocket = (config) => {
    ...
    const handleGroupNotification = (participant, child, msg) => {
        ...
        const participantJid = ((_b = (_a = (0, WABinary_1.getBinaryNodeChild)(child, 'participant')) === null || _a === void 0 ? void 0 : _a.attrs) === null || _b === void 0 ? void 0 : (_b.phone_number || _b.jid)) || participant;
        switch (child === null || child === void 0 ? void 0 : child.tag) {
            case 'create':
                ...
                msg.key = { participant: metadata.ownerPn };
            ...
            case 'modify':
                ...
                const oldNumber = (0, WABinary_1.getBinaryNodeChildren)(child, 'participant').map(p => (p.attrs.phone_number || p.attrs.jid));
            ...
            case 'leave':
                ...
                const participants = (0, WABinary_1.getBinaryNodeChildren)(child, 'participant').map(p => (p.attrs.phone_number || p.attrs.jid));
    ...
    const processNotification = async (node) => {
        ...
        const participant = (0, WABinary_1.jidNormalizedUser)(node.attrs.participant_pn || node.attrs.participant);
        switch (nodeType) {
            case 'privacy_token':
    ...
    const shouldRetry = (id, participant) => {
        const key = `${id}:${participant}`;
        const count = (msgRetryCache.get(key) || 0) + 1;
        if (count >= maxMsgRetryCount)
            return false;
            ...
            await Promise.all([
                processingMutex.mutex(async () => {
                    ...
                    if (msg) {
                        ...
                        (_a = msg.participant) !== null && _a !== void 0 ? _a : (msg.participant = (node.attrs.participant_pn || node.attrs.participant));
