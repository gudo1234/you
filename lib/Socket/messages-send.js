...
const makeMessagesSocket = (config) => {
    ...
    const { ev, authState, signalRepository, query, fetchPrivacySettings, sendNode, groupMetadata, groupToggleEphemeral, } = sock;
    ...
    const relayMessage = async (jid, message, { messageId: msgId, participant, additionalAttributes, additionalNodes, useUserDevicesCache, useCachedGroupMetadata, statusJidList }) => {
        ...
        const participants = [];
        const destinationJid = isStatus ? 'status@broadcast' : (0, WABinary_1.jidEncode)(user, isLid ? 'lid' : isGroup ? 'g.us' : 's.whatsapp.net');
            ...
            if (isGroup || isStatus) {
                const [groupData, senderKeyMap] = await Promise.all([
                    (async () => {
                        ...
                        if ((_a = data === null || data === void 0 ? void 0 : data.participants) === null || _a === void 0 ? void 0 : _a.length) {
                ...
                if (!participant) {
                    const participantsList = isStatus ? [...(statusJidList || [])] : (groupData === null || groupData === void 0 ? void 0 : groupData.participants.map(p => p.id)) || [];
                    if (!isStatus) {
